...
You can change these colors by editing the `src/components/Sidebar.astro` file. Simply use the find and replace feature in your code editor to change the colors, simply by searching